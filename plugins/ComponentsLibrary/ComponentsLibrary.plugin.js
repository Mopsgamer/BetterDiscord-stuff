...
module.exports = class ComponentsLibrary {
    ...
    start() {
        ...
        global.ComponentsLibrary.SvgPresets = {
            Logos: {
                discord: {
                    paths: [
        ...
        global.ComponentsLibrary.Text = class CL_Text extends React.Component {
        ...
        global.ComponentsLibrary.Switcher = class CL_Switcher extends React.Component {
                ...
                return React.createElement('div', {
                    ...
                    React.createElement('div',
                    {
                       class: `CL_SwitcherCircle`
                        ...
                        React.createElement(global.ComponentsLibrary.Svg, { viewBox: global.ComponentsLibrary.SvgPresets.ByDiscord.switcherTick.viewBox, paths: ['', ''] })
                    )
                )
            }
        }
        ...
        global.ComponentsLibrary.Textarea = class CL_Textarea extends React.Component {
                ...
                return React.createElement('textarea',
                    {
                        ...
                        class: `CL_Textarea ${textarea?.disabled ? 'disabled' : ''} ${textarea?.invalid ? 'invalid' : ''} ${textarea?.class ?? ''} ${ComponentsLibrary.modules.ScrollbarDefault}`,
                        onChange: (e) => {
                            textarea.onchange?.(e)
                        },
                        onClick: (e) => {
        ...
        global.ComponentsLibrary.Row = class CL_Row extends React.Component {
        ...
        global.ComponentsLibrary.Column = class CL_Column extends React.Component {
        ...
        global.ComponentsLibrary.Tabs = class CL_Tabs extends React.Component {
                        ...
                        React.createElement('div',
                            ...
                            tabs.map(
                                (tab, index) => {
                                    ...
                                    console.warn(`[ComponentsLibrary] "opened: true" in the Tab "${tab.name}", but there is already an open tab - "${tabs[openedReserved].name}".`)
        ...
        .CL_Switcher.checked svg > path:nth-child(1) {
            d: path('${global.ComponentsLibrary.SvgPresets.ByDiscord.switcherTick.paths[0]}');
        }
        .CL_Switcher.checked svg > path:nth-child(2) {
            d: path('${global.ComponentsLibrary.SvgPresets.ByDiscord.switcherTick.paths[1]}');
        }
        ...
        .CL_Switcher.unchecked svg > path:nth-child(1) {
            d: path('${global.ComponentsLibrary.SvgPresets.ByDiscord.switcherCross.paths[0]}');
        }
        .CL_Switcher.unchecked svg > path:nth-child(2) {
            d: path('${global.ComponentsLibrary.SvgPresets.ByDiscord.switcherCross.paths[1]}');
        }
