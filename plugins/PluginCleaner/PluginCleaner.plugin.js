...
module.exports = (meta) => {
    ...
    let ModuleStore = {
        ...
        SwitchRow: Webpack.getModule(Webpack.Filters.byStrings("tooltipNote"), { searchExports: true }),
    ...
    for (let m of Object.entries(ModuleStore)) {
        if (!m[1])
            Logger.error('Modules', m[0] + ' is not found.')
    }
    ...
    class Plugin {
        ...
        getSettingsPanel = () => {
            ...
            const { Button, Markdown, SwitchRow, Margin, Title } = ModuleStore;
