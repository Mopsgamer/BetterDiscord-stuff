 ...
 * @website https://github.com/Mopsgamer/BetterDiscord-codes/tree/PluginManager
 * @source https://raw.githubusercontent.com/Mopsgamer/BetterDiscord-codes/PluginManager/PluginManager.plugin.js
 * @updateUrl https://raw.githubusercontent.com/Mopsgamer/BetterDiscord-codes/PluginManager/PluginManager.plugin.js
 */
        ...
        getSettingsPanel = () => {
            ...
            class ListOf extends Listenable {
                    ...
                    if(TrustedPlugins) {
                        ...
                        for (let plug of CachePlugins) {
                            ...
                            if (!TrustedPlugins.some(tplug => tplug.name == plug.name)) {
                                plug.reasons.warning.push(' •  Unlisted in the fetched list.')
                            }
                ...
                function builder(/**@type {BDPluginData}*/uplug) {
                    ...
                    let isTrusted = !UntrustedPlugins.includes(uplug)
                            ...
                            React.createElement(
                                ...
                                [
                                        ...
                                        [
                                            ...
                                            React.createElement(
                                                ...
                                                [
                                                    ...
                                                    !uplug.author ? null : React.createElement(
                                    ...
                                    React.createElement(
                                        'div', { class: 'pman-controls' },
                                        [
                                            (!uplug.source || !isPartial || !isTrusted)
                                        ...
                                        [
                                            React.createElement(
                                                'button',
                                                {
                                                    ...
                                                    onClick: (e) => {
                                                        BdApi.UI.showConfirmationModal('Delete the file?', `${uplug.filename} will be removed.`, {
                                                            danger: true,
                                                            onConfirm() {
                                                                try {
                    ...
                    React.createElement(
                        ...
                        [
                            ...
                            React.createElement(
                                    ...
                                    onClick: async (e) => {
                                        ...
                                        request.get('https://api.betterdiscord.app/v1/store/addons',
                                            async (error, r, body) => {
                                                ...
                                                CheckDate = new Date()
                                                e.target.innerText = 'Fetch again'
                                                e.target.toggleAttribute('disabled', false)
                                                Listen.LIST.forceUpdate()
                                            }
                                        )
                                ...
                                Array.isArray(UntrustedPlugins) ? 'Fetch again' : 'Fetch'
                            )
                        ]
                    ),
                        ...
                        [
                            ...
                            React.createElement(
                                Button,
                                {
                                    ...
                                    size: Button.Sizes.SMALL,
                                    onClick: async () => {
                                        if (UnusedFiles) BdApi.UI.showConfirmationModal('Delete the files?', [UnusedFiles?.length + ' files will be removed:', ...UnusedFiles.map(u => u.filename)], {
                                            danger: true,
                                            onConfirm() {
